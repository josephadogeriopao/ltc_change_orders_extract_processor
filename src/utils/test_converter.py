...
class TestConverter(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Contains: property_id (should be dropped), PARCELID, ltc_comment (too long)
    ...
    def test_conversion_pipeline_behavior(self):
        ...
        headers = [ws.cell(row=1, column=c).value for c in range(1, 4) if ws.cell(row=1, column=c).value]
        ...
        self.assertEqual(parcel_val, "44445555")
